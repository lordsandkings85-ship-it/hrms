  ...
  return (
    <div className="p-8">
      <header className="mb-8">
        <h1 className="font-display text-2xl font-semibold">Travel Desk</h1>
        <p className="text-sm text-muted mt-1">Book official trips, claim travel cash advances, and record business travel histories.</p>
      </header>
