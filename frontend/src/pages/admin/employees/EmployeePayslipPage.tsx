...
import { Receipt, Search, Filter , Plus, MoreVertical, Edit2, Trash2 } from 'lucide-react';
    ...
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 shadow-sm relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="relative z-10 flex items-center gap-5">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[var(--text-primary)] tracking-tight">Payslip</h1>
            <p className="text-sm text-[var(--text-muted)] mt-1 font-medium">Generate and manage employee payslips.</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6 pb-4 border-b border-[var(--border)]">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="flex items-center gap-2 px-4 py-2 bg-indigo-500 text-white rounded-xl hover:bg-indigo-600 transition-colors shadow-sm text-xs font-bold uppercase tracking-wider">
              <Plus size={16} />
              <span>Add Employee Payslip</span>
            </button>
          </div>
        </div>
