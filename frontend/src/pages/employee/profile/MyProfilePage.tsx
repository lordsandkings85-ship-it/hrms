  ...
  return (
    <div className="page-container space-y-6 max-w-6xl animate-fade">
      ...
      >
        ...
        {/* Profile Avatar Wrapper with Large Gradient Ring */}
        <div className="relative shrink-0 group">
          <div className="absolute -inset-1 rounded-3xl bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 opacity-75 blur-md group-hover:opacity-100 transition-opacity duration-300" />
          <div className="relative w-32 h-32 md:w-36 md:h-36 rounded-3xl bg-slate-900 flex items-center justify-center text-white text-4xl md:text-5xl font-black font-display shadow-2xl shrink-0 select-none border-2 border-slate-700/60 overflow-hidden">
            {emp.photoUrl ? (
              <img
                src={emp.photoUrl}
