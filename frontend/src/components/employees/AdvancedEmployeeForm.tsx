      ...
      <div className="bg-white border rounded shadow-sm flex flex-col min-h-max">
        ...
        <div className="p-4 bg-gray-50 border-b relative">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 items-center gap-2">
                ...
                <select required className="col-span-2 border rounded px-2 py-1 text-sm" value={formData.designationId || ''} onChange={e => updateRoot('designationId', e.target.value)}>
                   ...
                   <option value="Accounts Associate">Accounts Associate</option>
                   ...
                   <option value="Associate Accountant">Associate Accountant</option>
            ...
            <div className="space-y-3 relative">
              <div className="absolute right-0 top-0">
                 <label className="flex items-center gap-2 text-xs text-gray-600">
                   <input type="checkbox" /> Ex employee
                 </label>
              </div>
          ...
          <div className="flex justify-end gap-2 mt-4">
            ...
            <button type="button" className="px-4 py-1.5 text-xs font-medium text-white bg-teal-500 hover:bg-teal-600 rounded shadow-sm">
